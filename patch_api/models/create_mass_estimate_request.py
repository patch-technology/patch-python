...
class CreateMassEstimateRequest(object):
    ...
    """
    openapi_types = {"mass_g": "int", "project_id": "str"}

    attribute_map = {"mass_g": "mass_g", "project_id": "project_id"}

    def __init__(
        self, mass_g=None, project_id=None, local_vars_configuration=None
    ):  # noqa: E501
