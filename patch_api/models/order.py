...
class Order(object):
    ...
    def __init__(self, id=None, created_at=None, mass_g=None, production=None, state=None, allocation_state=None, price_cents_usd=None, patch_fee_cents_usd=None, allocations=None, registry_url=None, metadata=None, local_vars_configuration=None):  # noqa: E501
    ...
    def state(self, state):
        ...
        allowed_values = ["draft", "placed", "processing", "complete", "cancelled"]  # noqa: E501
