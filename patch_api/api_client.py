...
from patch_api.exceptions import ApiTypeError, ApiValueError, ApiException
from patch_api.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __getattr__(self, method):
        ...
        from patch_api.apis import OrdersApi
        from patch_api.apis import ProjectsApi
        from patch_api.apis import TechnologyTypesApi
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = EstimatesApi()
        api_instance.create_bitcoin_estimate  # this is an instance of the class Endpoint
        api_instance.create_bitcoin_estimate()  # this invokes api_instance.create_bitcoin_estimate.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_bitcoin_estimate.callable or self.callable in this class
